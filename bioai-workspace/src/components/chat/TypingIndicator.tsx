    ...
    <div className={cn(
      ...
      className
        ...
        <div className="flex items-center gap-2 mb-3 text-xs text-gray-500">
          <Avatar className="chat-avatar-float w-6 h-6 shrink-0 bg-blue-600">
        ...
        <div className="chat-message-bubble assistant relative px-6 py-4 rounded-2xl shadow-sm bg-gray-50 border border-gray-200 typing-bubble">
