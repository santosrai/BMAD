...
const AdvancedMolstarViewer = React.forwardRef<ViewerControls, MolstarViewerProps>(
      ...
      <div className={`relative w-full h-full ${className || ''}`}>
        ...
        {isInitialized && !isLoading && (
          <div className="absolute top-4 right-4 flex flex-col space-y-2 z-20">
            <button
              onClick={resetView}
              className="bg-gray-800/90 hover:bg-gray-700 text-white p-2 rounded border border-gray-600"
              title="Reset View"
            >
        ...
        {currentSelection && (
          <div className="absolute bottom-4 left-4 right-4 z-20">
            <div className="bg-gray-800/90 border border-gray-600 rounded backdrop-blur-sm p-3">
...
AdvancedMolstarViewer.displayName = 'AdvancedMolstarViewer';

export default AdvancedMolstarViewer;